...
const WishListDettels = ({discauntparsent,discauntprice,imgsrc,title,price,}) => {
  return (
    <div className='py-10'>
      <Container>
           ...
           <div className='w-full max-w-70  rounded-sm group'>
            <div className='bg-[#F5F5F5] relative pt-11 pl-0 pb-11 overflow-hidden'>
             ...
             <img src={imgsrc} alt="" className='mx-auto' />
              ...
              <div className='size-10 absolute top-2 right-2 bg-white rounded-full flex items-center justify-center'>
